...
//    private RedisDao redisDao;
    ...
    public  PageUntil<Message>  messageList(Integer currentPage, Integer pageSize, Integer replay) {
        int start = (currentPage-1)*pageSize;
        List<Message> list =messageMapper.MessageList(replay,start,pageSize,currentPage);
        PageUntil<Message> pageUntil = new PageUntil<>();
